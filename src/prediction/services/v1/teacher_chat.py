...
from src.prediction.services.v1.get_template_queries import template_teacher_gpt3
...
class MissTm:
    ...
    async def draft_teacher_message(self, input_prompt, user_id):
        try:
            ...
            if user_id not in self.conversation_memories:
                ...
                prompt_template = PromptTemplate(input_variables=["history", "human_input"], template=template_teacher_gpt3)

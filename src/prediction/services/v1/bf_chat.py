...
from src.prediction.services.v1.get_template_queries import template_bf_gpt3
...
class MissTm:
    ...
    async def draft_bf_message(self, input_prompt, user_id):
        try:
            ...
            if user_id not in self.conversation_memories:
                ...
                prompt_template = PromptTemplate(input_variables=["history", "human_input"], template=template_bf_gpt3)
            ...
            return {"response": "best friend error"}
